                ...
                <div class="d-grid contact-addres-inf mt-5 pt-lg-4">
                    <div class="contact-info-left d-grid">
                        ...
                        <div class="contact-info">
                            ...
                            <div class="contact-details">
                                <h4>Phone:</h4>
                                <p><a href="tel:+598-658-456">+65 98117737</a></p>
                                <p><a href="tel:+598-658-457">+65 80531608</a></p>
                            </div>
                        </div>
                        <div class="contact-info">
                            <div class="icon">
                            ...
                            <div class="contact-details">
                                <h4>Mail:</h4>
                                <p><a href="mailto:mail@example.com" class="email">info@ScreenSavvy.com</a></p>
                                <p><a href="mailto:mail@example.com" class="email">ScreenSavvy@support.com</a></p>
                            </div>
                        </div>
                    </div>
                </div>
